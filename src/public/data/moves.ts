...
export type Movedex = {
  [key: string]: {
    ...
    type: BaseTypes;
    boosts?: {
      [key in BaseStat | "accuracy" | "evasion"]?: number;
    };
    breaksProtect?: true;
    condition?: {
      duration?: number;
    ...
    ignoreEvasion?: true;
    ignoreImmunity?: boolean | { Ground: true };
    isMax?: string | true;
    isNonstandard?: "CAP" | "Gigantamax" | "LGPE" | "Past" | "Unobtainable";
    isZ?: string;
    ...
    self?: {
      ...
      sideCondition?: "reflect" | "lightscreen" | "auroraveil";
    ...
    selfSwitch?: "copyvolatile" | "shedtail" | true;
    shortDesc?: string;
    sideCondition?: string;
    sleepUsable?: true;
    slotCondition?: "Wish" | "healingwish" | "lunardance" | "revivalblessing";
    smartTarget?: true;
    status?: Status;
    stealsBoosts?: true;
    stallingMove?: true;
    ...
    tracksTarget?: true;
    volatileStatus?: string;
    weather?: "RainDance" | "Sandstorm" | "hail" | "snow" | "sunnyday";
    willCrit?: true;
    overrideDefensiveStat?: BaseStat;
    overrideOffensivePokemon?: "target";
    overrideOffensiveStat?: BaseStat;
    zMove?: {
      boost?: {
        [key in BaseStat | "accuracy" | "evasion"]?: number;
      };
